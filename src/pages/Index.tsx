...
import { Plus, Search, UtensilsCrossed, Users, Package, Settings, LogOut, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      <div className="max-w-full px-4 sm:px-6 py-6 space-y-6">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 bg-secondary/30 p-2 rounded-2xl border border-border/40 flex-1 max-w-xl">
            ...
            <div className="flex items-center gap-4 pr-2 whitespace-nowrap">
              <div className="flex flex-col">
                <span className="text-[9px] text-muted-foreground uppercase font-bold tracking-tighter">Pedidos Hoje</span>
                <span className="text-sm font-black text-foreground leading-none">{todayCount}</span>
              </div>
              <div className="flex flex-col relative group">
                <div className="flex items-center gap-1.5">
                  <span className="text-[9px] text-muted-foreground uppercase font-bold tracking-tighter">Total Hoje</span>
                  <button 
